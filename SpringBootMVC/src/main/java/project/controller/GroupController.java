...
public class GroupController {
	...
	public GroupController(GroupService groupService, UserService userService) {
		...
		Group annunaki = new Group("Nörd", "Allir meðlimir nörd. Lorem ipsum dolor sit amet, consectetur adipiscing elit.",true);
		Group bubb = new Group("Bubb og co.", "Allir vinir hans bubba. Lorem ipsum dolor sit amet, consectetur adipiscing elit.",true);
		Group brh = new Group("BRH BOYS", "Bara fyrir boys úr Breiðholti. Lorem ipsum dolor sit amet, consectetur adipiscing elit.",true);
		Group golf = new Group("Golf Crew", "ef þú hefur áhuga á golfi.. Lorem ipsum dolor sit amet, consectetur adipiscing elit.",true);
		Group fjolla = new Group("Fjöllan", "Blöndal ættin. Lorem ipsum dolor sit amet, consectetur adipiscing elit.",true);
		Group bolta = new Group("BumbuBolti", "Bolti fyrir fólk með bumbu. Lorem ipsum dolor sit amet, consectetur adipiscing elit.",true);
		Group afm = new Group("Afmæli", "Vinum mínum sem er boðið í afmæli mitt. Lorem ipsum dolor sit amet, consectetur adipiscing elit.",true);
		Group bio = new Group("Bíóklúbburinn", "Bíó alla þriðjudaga, PEPP! Lorem ipsum dolor sit amet, consectetur adipiscing elit.",true);
		Group laera = new Group("Study-hópur", "Study hópur í hugbúnaðarverkefni 1. Lorem ipsum dolor sit amet, consectetur adipiscing elit.",true);
