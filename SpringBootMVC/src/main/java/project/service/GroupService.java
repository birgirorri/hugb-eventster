...
public class GroupService {
	...
	/*
	 * public Group createUser(Group group) { return repository.save(group); }
	 */
	...
	/*
	 * public User findUserByID(Long userID){ return repository.findOne(userID); }
	 */
	...
	/*
	 * public List<Group> findUserByGroup(int GroupID) { return
	 * repository.findGroupByID(groupID); }
	 */
